(function(Scratch) {
  ...
  class DatabaseManager {
    openDatabase(dbName) {
      return new Promise((resolve, reject) => {
        ...
        request.onupgradeneeded = event => {
          ...
          if (!db.objectStoreNames.contains('myStore')) { // Fixed store name: 'myStore'
    ...
    putValue(dbName, key, value) { // Simplified: dbName, key, value
    ...
    getValue(dbName, key) { // Simplified: dbName, key
      return this.openDatabase(dbName).then(db => {
        return new Promise((resolve, reject) => {
  ...
  class IndexedDBExtension {
        ...
        blocks: [
          {
            ...
            arguments: {
              NAME: { type: Scratch.ArgumentType.STRING, defaultValue: 'myDatabase' }
            }
          },
          {
          ...
          },
          {
            ...
            arguments: {
              ...
              DB_NAME: { type: Scratch.ArgumentType.STRING, defaultValue: 'myDatabase' }
            }
          },
          {
            opcode: 'getValue',
    ...
    putValue(args) {
      this.dbManager.putValue(prefix+'_'+args.DB_NAME, args.KEY, args.VALUE);
    }
